const ytLogoUrl = "https://yt3.googleusercontent.com";
const size = "=s160";
export default [
  {
    id: "@mohak_mangal",
    name: "Soch by Mohak Mangal",
    description: "I explain India using evidence. ",
    logo: `${ytLogoUrl}/XD4bb1LLkWZ4vUpgQ3EhIhIUZcs_AD_oT7G_jkrWxYm4KYPrF0u5TQ8vkKFas_76qbaujXcfXg${size}`,
  ...
  },
  {
    ...
    logo: `${ytLogoUrl}/ytc/AIdro_nmbQSAGKk1OZCBBf_sPJqLoFfYOVDWRDzALocBjGQtHeI${size}`,
    tags: ["maths"],
  },
  {
    id: "@computerphile",
    ...
    logo: `${ytLogoUrl}/ebHMyRfch3u2UTZN1WQJDp9J5U7o38T_WnGkd2QhAIQwBgvozdaOCOnfDMtngtoHWutJvLl4i0c${size}`,
    tags: ["computer"],
  },
  {
    id: "@TEDEdHindi",
    name: "जिज्ञासु बने रहें — TED-Ed",
    description: "हर हफ्ते कुछ नया सीखने के लिए सब्सक्राइब करें.\n\nTED-Ed का मिशन शेयर करने योग्य पाठ तैयार करना है। ",
    logo: `${ytLogoUrl}/EkDnDPhFwQy911uLUhEml3x4B4JT7eKSz1D7lzX6db18Sw_VJtHn3S9Jzo4ffrmvz7iWwUTE${size}`,
    tags: ["story", "random"],
  },
  {
    id: "@In59seconds",
  ...
  },
  {
    id: "@PrimerBlobs",
    name: "Primer",
    description: "Attempting to communicate the deep ideas of academic subjects.",
    logo: `${ytLogoUrl}/YicJ3lAVdXC5jI7SA7mnX7pPoULN2Gfgh_S4IgDPDPjLaeTx1vWiQeh-reCty2uWuoVK70K5Lg${size}`,
    tags: ["maths", "evolution", "simulation", "economics"],
  },
  {
    id: "@grandillusions",
  ...
  },
  {
    id: "@stevemould",
    name: "Steve Mould",
    description: "I make videos about science experiments and explains the science behind it",
    logo: `${ytLogoUrl}/iX-akiHlJYuPDq4YVBO83cfjWW0aQefdewmI326XVhZkzxnS3MrqNVi49J33jLBw5LR_ZVyKFA${size}`,
